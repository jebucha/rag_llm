...
def load_tokenizer(model_choice: str) -> AutoTokenizer:
    tokenizer_map = {
        ...
        # match the one you served on localhost:8080
        "llama3-q8": "hugging-quants/Llama-3.2-1B-Instruct-Q4_0-GGUF",
    }
...
def query_llama_server(model_choice: str, messages: list) -> str:
    payload = {
        "model": model_choice,
        "messages": messages,
    }
